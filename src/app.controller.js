...
let AppController = (() => {
    ...
    var AppController = class {
        ...
        static {
            ...
            _hello_decorators = [Get('/hello')];
            _store_decorators = [Post('/users')];
            ...
            __esDecorate(this, null, _store_decorators, { kind: "method", name: "store", static: false, private: false, access: { has: obj => "store" in obj, get: obj => obj.store }, metadata: _metadata }, null, _instanceExtraInitializers);
